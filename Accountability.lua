-----------------------------------------------------------------------------------------------
-- Client Lua Script for Accountability
-- Copyright (c) NCsoft. All rights reserved
-- CREATED BY: Allie, DoctorHouse
-----------------------------------------------------------------------------------------------

require "Window"
 
-----------------------------------------------------------------------------------------------
-- Accountability Module Definition
-----------------------------------------------------------------------------------------------
...
--Debugging
local AccountabilityDebug = false

-----------------------------------------------------------------------------------------------
-- Initialization
-----------------------------------------------------------------------------------------------
function Accountability:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
...
-----------------------------------------------------------------------------------------------
-- Accountability OnLoad
-----------------------------------------------------------------------------------------------
function Accountability:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("Accountability.xml")
	self.xmlDoc:RegisterCallback("OnDocLoaded", self)
	debugprint("Loading...")
end

-----------------------------------------------------------------------------------------------
-- Accountability OnDocLoaded
-----------------------------------------------------------------------------------------------
function Accountability:OnDocLoaded()
	self:InitWindow()
	...
	Apollo.RegisterSlashCommand("acc", "OnAccountabilityOn", self)
...
-----------------------------------------------------------------------------------------------
function Accountability:OnWindowManagementReady()
...
function Accountability:OnSave(eType)
...
function Accountability:OnRestore(eType, tSave)
	if eType ~= GameLib.CodeEnumAddonSaveLevel.Character then
        return nil
    end
...
function Accountability:ApplySettings()
...
function Accountability:OnGroupJoin()
...
function Accountability:OnGroupLeft()
...
function Accountability:OnGroupAdd(strNewGroupMember)
...
function Accountability:OnGroupRemove(playerName)
...
function Accountability:OnGroupMemberPromoted()
...
function Accountability:OnAbilityBookChange()
...
function Accountability:OnITChannelMessage(channel, tMsg, strSender)
...
function Accountability:SendUpdate()
...
function Accountability:UpdateGroup(name)
...
function Accountability:UpdateTotalIA(name)
...
function Accountability:UpdateMyInterrupts()
...
function Accountability:OnCheckInChannel()
...
function Accountability:CheckLAS()
...
function Accountability:CheckGroupStatus()
...
function Accountability:CheckMyCooldowns()
...
function Accountability:OnHalfSecond()
...
function Accountability:OnAccountabilityOn()
...
-----------------------------------------------------------------------------------------------
local AccountabilityInst = Accountability:new()
AccountabilityInst:Init()
